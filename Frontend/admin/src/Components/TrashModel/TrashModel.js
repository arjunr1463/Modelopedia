...
function TrashModel() {
  ...
  const data = useMemo(() => {
    const filters = Data.filter((row) => row.isDeleted);
  ...
  const handleTrash = (id) => {
    axios
      .post(`${process.env.REACT_APP_API_URL}/api/user/register/ModelRestore/${id}`)
      .then(() => fetchData());
  };
                    ...
                    <div className="flex flex-col gap-[10px]">
                      <div className="flex justify-center w-[200px]">
                        <div
                          ...
                          className="flex gap-[5px] cursor-pointer bg-black hover:bg-[#4099ff] hover:duration-300 text-white justify-center items-center w-[60px] h-[30px]"
                        >
                      ...
                      {selectedRow === id && action && (
                        <div className="flex justify-center absolute top-[10px] right-[135px]">
                          <div className="bg-white shadow-md px-[10px] py-[10px] rounded-[0.2rem] w-[100px] gap-[13px] text-[14px] flex flex-col items-start">
