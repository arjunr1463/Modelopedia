...
function EditSpecialStory() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/admin/home/SpecialStory")
    } catch (error) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-gray-100">
      <div className="bg-white rounded-md shadow-md flex flex-col gap-5 p-6 overflow-x-auto">
        <h2 className="font-bold">Edit Special Story</h2>
        <div className="flex font-fair">
            <span>Name:</span>
...
export default EditSpecialStory;
